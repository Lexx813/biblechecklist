...
// Self-host Plus Jakarta Sans via next/font/local. Gives us automatic
// size-adjust fallback metrics (no CLS on font swap), build-time hashing
// for immutable caching, and auto-preload on routes that use it.
// The 60+ CSS files in /src/styles/* hardcode the legacy family name
// 'Plus Jakarta Sans Variable', so we keep a single inline @font-face
// rule that points to the same physical woff2 — both font-faces map to
// the same file, the browser dedupes the network fetch.
  ...
  return (
    <html lang="en" className={jakarta.variable} suppressHydrationWarning>
      <head>
        ...
        {/* next/font/local handles font preload + hashed @font-face automatically.
      ...
      <body>
        ...
        {/* @next/third-parties/google loads GA4 with the optimal strategy
            (web-worker-ready, lazy by default) and is maintained by Next.js
            so it stays current with GA4 / Lighthouse best practices. */}
