    ...
    <nav className="sticky top-0 z-30 border-b border-slate-200/70 bg-white/85 backdrop-blur-md dark:border-white/10 dark:bg-[#160f2e]/90">
      <div className="flex items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-0.5 text-sm font-medium">
          ...
          <Link href="/messianic-prophecies" className="hidden lg:inline-flex rounded-md px-3 py-1.5 text-slate-700 transition hover:bg-violet-50 hover:text-violet-700 dark:text-slate-200 dark:hover:bg-white/5 dark:hover:text-violet-300">Prophecies</Link>
