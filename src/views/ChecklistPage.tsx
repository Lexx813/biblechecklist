      ...
      <div className="app-wrap" id="main-content">
              ...
              <div className="cl-study-tools-section">
                ...
                <div className="cl-study-tools">
                  {([
                    ...
                    {
                      key: "studyTopics",
                      label: t("nav.studyTopics", "Topics"),
                      icon: (
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    ...
                    {
                      key: "history",
                      label: t("nav.readingHistory", "History"),
                      icon: (
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  ...
                  ] as { key: string; label: string; icon: React.ReactNode }[]).map(tool => (
                    <button key={tool.key} className="cl-study-tool" onClick={() => navigate(tool.key)} style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                      {tool.icon}
                      {tool.label}
                    </button>
                  ))}
        ...
        {showBookPrompt && (
          <UpgradePrompt
            ...
            title={t("checklist.planPromptTitle", "Add a reading plan")}
            message={t("checklist.planPromptMessage", "Join a structured plan to read the entire New World Translation, with daily checkpoints.")}
            ctaLabel={t("checklist.planPromptCta", "View reading plans")}
            onCta={() => {
