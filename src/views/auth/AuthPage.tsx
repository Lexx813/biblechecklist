  ...
  return (
    <div className="auth-wrap">
      <div className="auth-topbar">
        ...
        <button className="auth-theme-toggle" onClick={toggleDark} aria-label={darkMode ? t("auth.switchLight") : t("auth.switchDark")}>
  ...
  <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>
        ...
        <div className="auth-social">
          ...
          >
            ...
            {googleBusy ? t("auth.redirecting") : "Continue with Google"}
          </button>
          <button
            type="button"
            className="auth-google-btn auth-facebook-btn"
          ...
          >
            ...
            {facebookBusy ? t("auth.redirecting") : "Continue with Facebook"}
          </button>
        </div>
