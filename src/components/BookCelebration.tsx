...
export default function BookCelebration({ bookName, bookIcon, chaptersCount, totalDoneBooks, onClose }: Props) {
  ...
  return createPortal(
    <div className="celebrate-overlay" onClick={onClose}>
      <div className="celebrate-confetti" ref={confettiRef} />
      <div className="celebrate-modal" role="dialog" aria-modal="true" aria-label="Book completion celebration" onClick={e => e.stopPropagation()}>
