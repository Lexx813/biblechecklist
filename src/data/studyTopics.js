...
export const STUDY_TOPICS = [
    ...
    sections: [
      {
        ...
        scriptures: [
          ...
          { ref: "1 Corinthians 8:6", text: "There is one God, the Father… and one Lord, Jesus Christ." },
      ...
      },
      {
        ...
        scriptures: [
          { ref: "Matthew 3:17", text: "This is my Son, the beloved, whom I have approved." },
          { ref: "Colossians 1:15", text: "He is the image of the invisible God, the firstborn of all creation." },
          { ref: "Matthew 24:36", text: "Concerning that day and hour nobody knows, neither the angels of the heavens nor the Son, but only the Father." },
        ],
      },
      {
        ...
        scriptures: [
          ...
          { ref: "Hebrews 7:25", text: "He is able to save completely those who approach God through him." },
        ],
      },
    ],
  },
  ...
  {
    id: "jesus-and-michael",
    slug: "jesus-and-michael",
    icon: "⚔️",
    ...
    sections: [
      {
        ...
        scriptures: [
          { ref: "Daniel 12:1", text: "Michael will stand up, the great prince who is standing in behalf of your people." },
          { ref: "Jude 9", text: "But when Michael the archangel had a dispute with the Devil and was arguing about Moses' body, he did not dare to bring a judgment against him in abusive terms." },
      ...
      },
      {
        ...
        scriptures: [
          { ref: "Revelation 12:7-9", text: "Michael and his angels battled with the dragon… the great dragon was hurled down." },
          { ref: "Colossians 1:15-16", text: "He is the image of the invisible God, the firstborn of all creation; because by means of him all other things were created." },
          { ref: "Philippians 2:9", text: "God exalted him to a superior position and kindly gave him the name that is above every other name." },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        scriptures: [
          { ref: "Genesis 1:2", text: "God's active force was moving about over the surface of the waters." },
      ...
      },
      {
        ...
        scriptures: [
          ...
          { ref: "Romans 8:26", text: "The spirit itself pleads for us with unuttered groanings." },
          { ref: "1 Corinthians 12:11", text: "All of these are the work of one and the same spirit." },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        scriptures: [
          { ref: "Genesis 2:7", text: "The man came to be a living person [soul]." },
          { ref: "Ezekiel 18:4", text: "Look! All the souls — to me they belong. As the soul of the father, so also the soul of the son — to me they belong. The soul who sins is the one who will die." },
          { ref: "1 Corinthians 15:45", text: "So it is written: 'The first man Adam became a living person [soul].'" },
        ],
      },
      {
        ...
        scriptures: [
          { ref: "Ezekiel 18:4", text: "The soul who sins is the one who will die." },
          { ref: "Revelation 16:3", text: "Every living soul in the sea died." },
          { ref: "Acts 3:23", text: "Any soul that does not listen to that Prophet will be completely destroyed from among the people." },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        scriptures: [
          { ref: "John 11:11-14", text: "'Lazarus our friend has fallen asleep… Lazarus has died.'" },
          { ref: "Ecclesiastes 9:5", text: "The living are conscious that they will die, but the dead are not conscious of anything at all." },
      ...
      },
      {
        ...
        scriptures: [
          { ref: "John 5:28-29", text: "All those in the memorial tombs will hear his voice and come out." },
          { ref: "Acts 24:15", text: "There is going to be a resurrection of both the righteous and the unrighteous." },
          { ref: "1 Corinthians 15:26", text: "The last enemy, death, is to be brought to nothing." },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        scriptures: [
          { ref: "Daniel 2:44", text: "The God of heaven will set up a kingdom that will never be brought to ruin." },
          { ref: "Matthew 6:10", text: "Let your Kingdom come. Let your will take place, as in heaven, also on earth." },
          { ref: "Luke 1:33", text: "He will rule as King over the house of Jacob forever, and there will be no end to his Kingdom." },
        ],
      },
      {
        ...
        scriptures: [
          { ref: "Revelation 21:3-4", text: "He will wipe out every tear from their eyes, and death will be no more." },
          { ref: "Isaiah 65:21-22", text: "They will build houses and live in them, and they will plant vineyards and eat their fruit." },
    ...
    sections: [
      {
        ...
        scriptures: [
          { ref: "Job 1:9-11", text: "Does Job fear God for nothing?" },
          { ref: "Genesis 3:4-5", text: "You certainly will not die. God knows that… your eyes will be opened and you will be like God." },
          { ref: "Romans 3:4", text: "Let God be found true, even if every man is a liar." },
        ],
      },
      {
        ...
        scriptures: [
          { ref: "2 Peter 3:9", text: "Jehovah is not slow concerning his promise… he is patient with you." },
          { ref: "Romans 8:22", text: "We know that all creation keeps on groaning together and being in pain together until now." },
          { ref: "Revelation 11:18", text: "The time came… to bring to ruin those ruining the earth." },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        scriptures: [
          { ref: "Genesis 9:4", text: "Only flesh with its life — its blood — you must not eat." },
          { ref: "Leviticus 17:14", text: "You must not eat the blood of any sort of flesh, because the life of every sort of flesh is its blood." },
          { ref: "Acts 15:28-29", text: "The holy spirit and we ourselves have favored adding no further burden to you except these necessary things: to keep abstaining from… blood." },
        ],
      },
      {
        ...
        scriptures: [
          ...
          { ref: "1 John 5:3", text: "This is what the love of God means, that we observe his commandments; and yet his commandments are not burdensome." },
          { ref: "Proverbs 3:5", text: "Trust in Jehovah with all your heart, and do not rely on your own understanding." },
        ],
      },
    ],
  },
