    ...
    <tr><td style="padding:32px 40px">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(124,58,237,0.08);border:1px solid rgba(124,58,237,0.2);border-radius:12px;margin-bottom:24px">
        <tr><td style="padding:16px 20px;text-align:center">
          ...
          <p style="margin:6px 0 0;font-size:12px;color:rgba(255,255,255,0.4)">Cancel anytime · No commitment</p>
        </td></tr>
      </table>
      <div style="text-align:center;margin-bottom:12px">${ctaButton("Unlock Premium →", `${SITE}/settings`)}</div>
...
Deno.serve(async (req) => {
  ...
  const now = new Date();
  const results = { welcome: 0, day3: 0, day7: 0, errors: 0 };

  // Define the three cohorts to process
  ...
  console.log("Onboarding emails sent:", results);
